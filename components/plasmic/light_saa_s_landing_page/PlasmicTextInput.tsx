...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: pXPiyXLyU2L1/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <Searchsvg2Icon
              className={classNames(projectcss.all, sty.svg__ef5O4)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg___6S6E)}
              role={"img"}
            />
          ),
