...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 0Ysx4aWQQj8u/css
    ...
    >
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__joNfs)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__rtPpG)}
                role={"img"}
              />
            ),
